...
<li>
  ...
  <ul>
    ...
    <li>Designed novel MTL‑based reward to uncover 2‑D vulnerabilities (vs 1‑D) in adversarial RL.</li>
...
<li>
  ...
  <ul>
    <li>Automated company‑wide meeting summaries via Azure Functions + Microsoft Graph, saving 90 hours/month.</li>
    <li>Eliminated <strong>$250k/yr</strong> Teams Premium spend using GPT‑4o summarization.</li>
    <li>Built Python prompt‑engineering toolkit; codebase adopted by two engineers.</li>
    <li>Enhanced CNN training pipeline (EfficientNetV2, AUC 0.97) with DuckDB, S3 and PyTests.</li>
  </ul>
</li>
<li>
  <table>
